 ...
 * @return
 */
string generateRcognizerData(string localizer_testdata_original_image,
...
void compareLocalizerResults(BBList tags, TagList taglist, TagList &found,
...
void exportLocalizerTestResults(TagList found, TagList wrongFound,
	...
	//found in green
	void _exportLocalizerTestResults_helper(found, exportImage,
	...
	//wrong found in blue
	void _exportLocalizerTestResults_helper(wrongFound, exportImage,
	...
	//not found in red
	void _exportLocalizerTestResults_helper(notFound, exportImage,
	...
	try {
		...
		if (vm.count("r")) {
			if (!vm.count("l") && !vm.count("rf")) {
				...
				string response = testgenerator::generateRcognizerData(
